...
def load_model(input):
    ...
    from Trufor.src.config import update_config
    from Trufor.src.config import _C as config
    from Trufor.src.data_core import myDataset
    ...
    parser.add_argument(
        ...
        "--save_np",
        action="store_true",
        help="whether to save the Noiseprint++ or not",
    )
    parser.add_argument(
    ...
    )  # 1 to allow arbitrary input sizes
